...
# GAMEPLAY
enum TRIGGER_CONDITION { NONE, ON_PRE_ATTACK, ON_PRE_HIT, ON_BLOCKED_HIT, ON_TAKE_HIT, ON_POST_HIT, ON_POST_ATTACK,\
...
const TIME_BETWEEN_MOVES_ADJACENT_TO_PLAYER:float = 0.0
