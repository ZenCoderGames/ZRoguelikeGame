...
enum TRIGGER_CONDITION { ON_PRE_ATTACK, ON_PRE_HIT, ON_BLOCKED_HIT, ON_TAKE_HIT, ON_POST_HIT, ON_POST_ATTACK,\
							...
							ON_ADD_STATUS_EFFECT_TO_SELF, ON_ADD_STATUS_EFFECT_TO_ENEMY }
...
const CAMERA_SHAKE_DEFAULT_TRAUMA:float = 0.1
const CAMERA_SHAKE_KILL_TRAUMA:float = 0.15

const TIME_BETWEEN_MOVES:float = 0.01
const TIME_BETWEEN_MOVES_ADJACENT_TO_PLAYER:float = 0.01
