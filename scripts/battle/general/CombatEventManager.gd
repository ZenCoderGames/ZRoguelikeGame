...
signal OnPlayerSpecialAbilityCompleted(special)
signal OnPlayerSpecialAbilityPressed(special)
signal OnPlayerSpecialAbilityFailedToActivate(special)
signal OnPlayerSpecialSelectionActivated(special)
signal OnPlayerSpecialSelectionCompleted(special, dirn)
...
signal OnAnyCharacterDeathFinal(character)
